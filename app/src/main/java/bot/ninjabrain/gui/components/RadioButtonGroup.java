...
import bot.ninjabrain.gui.SizePreference;
...
class ThemedRadioButton extends JRadioButton implements ThemedComponent {
	...
	private static ImageIcon icon = new ImageIcon(Main.getResource("radio_icon.png"));
	private static ImageIcon selected_icon = new ImageIcon(Main.getResource("radio_selected_icon.png"));
	private static ImageIcon pressed_icon = new ImageIcon(Main.getResource("radio_pressed_icon.png"));
	private static ImageIcon rollover_icon = new ImageIcon(Main.getResource("radio_rollover_icon.png"));
	private static ImageIcon selected_rollover_icon = new ImageIcon(Main.getResource("radio_selected_rollover_icon.png"));
